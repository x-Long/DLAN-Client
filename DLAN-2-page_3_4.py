...
# Form implementation generated from reading ui file 'DLAN-2-page_3_4.ui'
#
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_progress_time.sizePolicy().hasHeightForWidth())
        self.label_progress_time.setSizePolicy(sizePolicy)
        self.label_progress_time.setMinimumSize(QtCore.QSize(60, 0))
        self.label_progress_time.setMaximumSize(QtCore.QSize(16777215, 16777215))
...
"")
        ...
        self.pushButton_computer_info = QtWidgets.QPushButton(self.frame)
...
"")
        ...
        self.verticalLayout_11 = QtWidgets.QVBoxLayout(self.frame_computer_info)
...
"")
        ...
        self.pushButton_net_info = QtWidgets.QPushButton(self.frame)
...
"")
        ...
        spacerItem1 = QtWidgets.QSpacerItem(20, 316, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.verticalLayout_18 = QtWidgets.QVBoxLayout(self.page_hard_disk_info)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_progress_time_3.sizePolicy().hasHeightForWidth())
        self.label_progress_time_3.setSizePolicy(sizePolicy)
        self.label_progress_time_3.setMinimumSize(QtCore.QSize(60, 0))
        self.label_progress_time_3.setMaximumSize(QtCore.QSize(16777215, 16777215))
...
"color: #FFFFFF;")
        ...
        self.scrollArea_content_2 = QtWidgets.QScrollArea(self.page_hard_disk_info)
...
"")
        ...
        self.pushButton_net_info_2 = QtWidgets.QPushButton(self.frame_9)
...
"")
        ...
        spacerItem2 = QtWidgets.QSpacerItem(20, 316, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
...
"}")
        ...
        self.tableWidget_3.setAutoScrollMargin(3)
        ...
        self.tableWidget_3.horizontalHeader().setDefaultSectionSize(139)
...
"}")
        ...
        self.tableWidget_4.setAutoScrollMargin(3)
        ...
        self.tableWidget_4.horizontalHeader().setDefaultSectionSize(139)
...
"")
        ...
        self.tableWidget_5.setStatusTip("")
        self.tableWidget_5.setStyleSheet("        QTableView\n"
"{\n"
"    background-color: #FFFFFF;\n"
"    alternate-background-color:#e3edf9;\n"
"    font:14px \"微软雅黑\";\n"
...
"}")
        ...
        self.tableWidget_5.setAutoScrollMargin(3)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_progress_time_2.sizePolicy().hasHeightForWidth())
        self.label_progress_time_2.setSizePolicy(sizePolicy)
        self.label_progress_time_2.setMinimumSize(QtCore.QSize(60, 0))
        self.label_progress_time_2.setMaximumSize(QtCore.QSize(16777215, 16777215))
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_15.setText(_translate("Form", "ASUST eK COMPUTER INC. - X542UF"))
        ...
        self.label_20.setText(_translate("Form", "Inter(R) Core(TM) i7-8550U CPU 1.8GHz"))
        ...
        self.label_57.setText(_translate("Form", "ASUST eK COMPUTER INC. - X542UF"))
        ...
        self.label_63.setText(_translate("Form", "Inter(R) Core(TM) i7-8550U CPU 1.8GHz"))
        self.label_progress_time_3.setText(_translate("Form", "02:00"))
        self.label_86.setText(_translate("Form", "100%"))
        self.pushButton_pause_3.setText(_translate("Form", "暂停检查"))
        self.pushButton_stop_3.setText(_translate("Form", "停止检查"))
        self.label_39.setText(_translate("Form", "       项目"))
        self.label_40.setText(_translate("Form", "|"))
        self.label_41.setText(_translate("Form", " 基本信息"))
        self.pushButton_net_info_2.setText(_translate("Form", "  网络信息"))
        self.label_76.setText(_translate("Form", "名称"))
        self.label_77.setText(_translate("Form", "Samsung SSD 960 EVO 1TB"))
        self.label_78.setText(_translate("Form", "序列号"))
        self.label_79.setText(_translate("Form", "0025_3852_81B1_E5F9."))
        self.label_80.setText(_translate("Form", "容量"))
        self.label_81.setText(_translate("Form", "931.51 GB"))
        self.label_progress_time_4.setText(_translate("Form", "02:00"))
        self.label_42.setText(_translate("Form", "100%"))
        self.pushButton_pause_4.setText(_translate("Form", "暂停检查"))
        self.pushButton_stop_4.setText(_translate("Form", "停止检查"))
        ...
        self.pushButton_stop_7.setText(_translate("Form", "停止检查"))
        ...
        self.tabWidget_5.setTabText(self.tabWidget_5.indexOf(self.tab_6), _translate("Form", "Tab 1"))
        self.label_progress_time_2.setText(_translate("Form", "02:00"))
        self.label_35.setText(_translate("Form", "100%"))
        self.pushButton_pause_2.setText(_translate("Form", "暂停检查"))
        self.pushButton_stop_2.setText(_translate("Form", "停止检查"))
        self.label_36.setText(_translate("Form", "偏移过滤："))
        self.comboBox.setItemText(0, _translate("Form", "不限偏移"))
        self.comboBox.setItemText(1, _translate("Form", "精准"))
        self.comboBox.setItemText(2, _translate("Form", "标题"))
        self.comboBox.setItemText(3, _translate("Form", "概要"))
        self.label_37.setText(_translate("Form", " 文件类型："))
        self.comboBox_2.setItemText(0, _translate("Form", "全部类型"))
        self.comboBox_2.setItemText(1, _translate("Form", "文档"))
        self.comboBox_2.setItemText(2, _translate("Form", "压缩包"))
        self.label_38.setText(_translate("Form", " 是否加密："))
        self.comboBox_3.setItemText(0, _translate("Form", "不限"))
        self.comboBox_3.setItemText(1, _translate("Form", "加密文件"))
        self.comboBox_3.setItemText(2, _translate("Form", "所有文件"))
        self.pushButton.setText(_translate("Form", "常规文件检查配置"))
