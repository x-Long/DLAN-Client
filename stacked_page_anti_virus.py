...
class Runthread_anti_virus_info(QtCore.QThread):
...
class Stacked_page_anti_virus_4(object):
    ...
    def set_up_stacked_page_anti_virus_4(self):

        self.stacked_page_anti_virus_4_ui()
        self.pushButton_0_3_3.clicked.connect(self.switche_anti_virus_page)
        self.thread_get_anti_virus_info()

    def switche_anti_virus_page(self):
        self.stackedWidget.setCurrentIndex(6)

    def thread_get_anti_virus_info(self):

        self.thread_anti_virus_info = Runthread_anti_virus_info() # 创建线程
        self.thread_anti_virus_info._signal.connect(self.add_anti_virus_row) # 连接信号
        self.thread_anti_virus_info.start() # 开始线程

    def page_anti_virus_4(self):

        self.init_anti_virus_table_widget()
        self.tableWidget_5.setHorizontalHeaderLabels(["序号","名称",  "版本", "安装路径"])
    ...
    def init_anti_virus_table_widget(self):
        ...
        self.tableWidget_5.horizontalHeader().setSectionResizeMode(0, QHeaderView.Interactive)
        # self.tableWidget_5.horizontalHeader().resizeSection(0, 40)  # 修改表头第一列的宽度为30
        self.tableWidget_5.setColumnWidth(0, 40)

        # self.tableWidget_5.horizontalHeader().setSectionResizeMode(1, QHeaderView.Interactive)
        # # self.tableWidget_5.horizontalHeader().resizeSection(1, 40)  # 修改表头第一列的宽度为30
        # self.tableWidget_5.setColumnWidth(1, 40)

        # self.tableWidget_5.horizontalHeader().setSectionResizeMode(2, QHeaderView.Interactive)
        # self.tableWidget_5.horizontalHeader().resizeSection(2, 150)  # 修改表头第一列的宽度为30
        # self.tableWidget_5.horizontalHeader().setSectionResizeMode(4, QHeaderView.Interactive)
        # self.tableWidget_5.horizontalHeader().resizeSection(4, 200)  # 修改表头第一列的宽度为30
        # self.tableWidget_5.horizontalHeader().setSectionResizeMode(6, QHeaderView.Interactive)
        # self.tableWidget_5.horizontalHeader().resizeSection(6, 200)  # 修改表头第一列的宽度为30

 
    def usb_anti_virus_style(self):
        ...
        # 滚动条样式
        self.tableWidget_5.verticalScrollBar().setStyleSheet("QScrollBar:vertical{"  # 垂直滑块整体
        ...
        self.tableWidget_5.horizontalScrollBar().setStyleSheet("QScrollBar:horizontal{"
                                                             "background:#FFFFFF;"
                                                             "padding-top:3px;"
                                                             "padding-bottom:3px;"
                                                             "padding-left:10px;"
    ...
    def stacked_page_anti_virus_4_ui(self):
