...
class Runthread_file_access_records_info(QtCore.QThread):
...
class Stacked_page_file_access_records_4(object):

    def set_up_stacked_page_file_access_records_4(self):

        self.stacked_page_file_access_records_4_ui()
        self.pushButton_0_4_0.clicked.connect(
            self.switche_file_access_records_page)
        self.thread_get_file_access_records_info()

    def switche_file_access_records_page(self):
        self.stackedWidget.setCurrentIndex(7)

    def thread_get_file_access_records_info(self):

        self.thread_file_access_records_info = Runthread_file_access_records_info()  # 创建线程
        self.thread_file_access_records_info._signal.connect(
            self.add_file_access_records_row)  # 连接信号
        self.thread_file_access_records_info.start()  # 开始线程

    def page_file_access_records_4(self):

        self.init_file_access_records_table_widget()
        # self.tableWidget_6.setHorizontalHeaderLabels(["序号","用户名", "使用时间", "文件路径","是否存在"])
        self.tableWidget_6.setHorizontalHeaderLabels(
            ["序号", "文件路径", "使用时间", "是否存在"])
        self.usb_file_access_records_style()

    def add_file_access_records_row(self, content):
        ...
        for item in content:
            num = self.tableWidget_6.rowCount()
            self.tableWidget_6.setRowCount(num+1)

            add_item(num, 0, num+1)   # 序号
            # add_item(num, 1, item["username"])
            # add_item(num, 2, item["access_time"])
            # add_item(num, 3, item["file_path"])
            # add_item(num, 4, item["is_exists"])

            # add_item(num, 1, item["username"])
            add_item(num, 1, item["file_path"])
            add_item(num, 2, item["access_time"])
            add_item(num, 3, item["is_exists"])

    def init_file_access_records_table_widget(self):
        ...
        self.tableWidget_6.horizontalHeader().setSectionResizeMode(0,
                                                                   QHeaderView.Interactive)
        # self.tableWidget_6.horizontalHeader().resizeSection(0, 40)  # 修改表头第一列的宽度为30
        self.tableWidget_6.setColumnWidth(0, 40)

        # self.tableWidget_6.horizontalHeader().setSectionResizeMode(1, QHeaderView.Interactive)
        # # self.tableWidget_6.horizontalHeader().resizeSection(1, 40)  # 修改表头第一列的宽度为30
        # self.tableWidget_6.setColumnWidth(1, 40)

        # self.tableWidget_6.horizontalHeader().setSectionResizeMode(2, QHeaderView.Interactive)
        # self.tableWidget_6.horizontalHeader().resizeSection(2, 150)  # 修改表头第一列的宽度为30
        # self.tableWidget_6.horizontalHeader().setSectionResizeMode(4, QHeaderView.Interactive)
        # self.tableWidget_6.horizontalHeader().resizeSection(4, 200)  # 修改表头第一列的宽度为30
        # self.tableWidget_6.horizontalHeader().setSectionResizeMode(6, QHeaderView.Interactive)
        # self.tableWidget_6.horizontalHeader().resizeSection(6, 200)  # 修改表头第一列的宽度为30

    def usb_file_access_records_style(self):
        ...
        # 滚动条样式
        self.tableWidget_6.verticalScrollBar().setStyleSheet("QScrollBar:vertical{"  # 垂直滑块整体
        ...
        self.tableWidget_6.horizontalScrollBar().setStyleSheet("QScrollBar:horizontal{"
                                                               "background:#FFFFFF;"
                                                               "padding-top:3px;"
                                                               "padding-bottom:3px;"
                                                               "padding-left:10px;"
    ...
    def stacked_page_file_access_records_4_ui(self):
        ...
        self.tableWidget_6 = QtWidgets.QTableWidget(self.tab_7)
        self.page_file_access_records_4()
        ...
        self.label_progress_time_8.setText("02:00")
        self.label_46.setText("100%")
        self.pushButton_pause_8.setText("暂停检查")
        self.pushButton_stop_8.setText("停止检查")
        self.tabWidget_6.setTabText(
            self.tabWidget_6.indexOf(self.tab_7),  "文件使用纪录")
