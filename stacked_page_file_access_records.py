...
class Runthread_file_access_records_info(QtCore.QThread):
    ...
    def run(self):
        print("run")
        net_info=json.loads(requests.get("http://localhost//v1.0/native/get_file_access_records").content)
...
class Stacked_page_file_access_records_4(object):
    ...
    def set_up_stacked_page_file_access_records_4(self):
        ...
        self.pushButton_0_4_0.clicked.connect(self.switche_file_access_records_page)
    ...
    def thread_get_file_access_records_info(self):
        ...
        self.thread_file_access_records_info._signal.connect(self.add_file_access_records_row) # 连接信号
    ...
    def init_file_access_records_table_widget(self):
        ...
        self.tableWidget_6.horizontalHeader().setSectionResizeMode(0, QHeaderView.Interactive)
...
"")
        ...
        self.tabWidget_6.setTabText(self.tabWidget_6.indexOf(self.tab_7),  "文件使用纪录")